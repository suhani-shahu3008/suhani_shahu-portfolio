...
/**
 * Portfolio-local pill variant of ThreeUI's LiquidMetalButton, built from the
 * real registered source (src/shaders/liquid-metal-button/liquid-metal-button.html.js,
 * copied byte-for-byte from node_modules and patched only for icon + font-size —
 * see that file's diff against the original). The WebGL shader, ripple/hover
 * physics and bloom pipeline are untouched.
 */
