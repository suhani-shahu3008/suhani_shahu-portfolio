...
/**
 * Custom lerped-ring cursor that swells over any `[data-cursor]` element.
 * Hidden on touch devices (`matchMedia('(hover: none)')`). Full-viewport
 * fixed-position effect — mount once near the app root.
 */
