...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .btn .ico{
    width:calc(150 * var(--u));height:calc(150 * var(--u));
...
<div class="stage" id="stage">
  ...
  <button class="btn" id="btn" type="button">
    ...
    <svg class="ico" viewBox="0 0 115 115" aria-hidden="true">
      <g stroke="currentColor" stroke-width="13" stroke-linecap="round" stroke-linejoin="round" fill="none">
        <path d="M57.5 10 V64"/>
        <path d="M33 42 L57.5 66.5 L82 42"/>
        <path d="M15 84 V104.5 H100 V84"/>
      </g>
    </svg>
  </button>
</div>
