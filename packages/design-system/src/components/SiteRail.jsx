...
/**
 * Vertical scroll-spy progress rail. Pass `sections` with an `id` on each
 * entry to wire it to real page sections via IntersectionObserver + smooth
 * scroll; omit `id` to render it decorative-only.
 * @param {{ sections?: Array<{ label: string, id?: string }> }} props
 */
